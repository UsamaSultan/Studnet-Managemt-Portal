<%@ Page Title="" Language="C#" MasterPageFile="~/Coordinator.Master" AutoEventWireup="true" CodeBehind="coordinatorViewProfile.aspx.cs" Inherits="Naive2.coordinatorViewProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="container">
        <form id="form1" role="form" class="form-horizontal" runat="server">
            <p class="h1" id="mainHeading">View Profile</p>
