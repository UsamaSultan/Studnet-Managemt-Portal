<%@ Page Title="" Language="C#" MasterPageFile="~/Coordinator.Master" AutoEventWireup="true" CodeBehind="coordinatorUploadIdea.aspx.cs" Inherits="Naive2.coordinatorUploadIdea" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" role="form" class="form-horizontal" runat="server">
        <div class="container">
            <p class="h1" id="mainHeading">Upload Project Idea</p>
            <br />
            <br />
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
                ...
                <div class="col-sm-offset-2 col-sm-7">
                    <asp:Button class="btn btn-default" Text="Upload Idea" runat="server"/>
                </div>
             </div>
        </div>
    </form>
