<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="adminAddSupervisor.aspx.cs" Inherits="Naive2.adminAddSupervisor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <form id="form1" role="form" class="form-horizontal" runat="server">
            <p class="h1" id="mainHeading">Add Supervisor</p>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-offset-2 col-sm-7">
                    <asp:Button class="btn btn-default" Text="Add Supervisor" runat="server"/>
                </div>
             </div>
        </form>
    </div>
