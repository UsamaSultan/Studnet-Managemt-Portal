<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="adminAddCoordinator.aspx.cs" Inherits="Naive2.adminAddCoordinator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <form id="form1" role="form" class="form-horizontal" runat="server">
            <p class="h1" id="mainHeading">Add Coordinator</p>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <asp:DropDownList class="form-control" id="Field"  runat="server"></asp:DropDownList>
                </div>
            </div>
            <div class="form-group row">
                <asp:Label for="CoordinatedFYP" class="col-sm-2 col-form-label" runat="server">Coordinated FYP</asp:Label>
                <div class="col-sm-8">
                    <asp:DropDownList class="dropdown" ID="CoordinatedFyp"  runat="server">
                           <asp:ListItem  Text="FYP1" Value="1"></asp:ListItem>
                           <asp:ListItem  Text="FYP2" Value="2"></asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>
             <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-offset-2 col-sm-7">
                    <asp:Button class="btn btn-default" ID="btnAddCoordinator" OnClick="btnAddCoordinator_Click" Text="Add Coordinator" runat="server"/>
                </div>
             </div>
        </form>
    </div>
