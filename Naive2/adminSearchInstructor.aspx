<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="adminSearchInstructor.aspx.cs" Inherits="Naive2.adminSearchInstructor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" role="form" class="form-horizontal" runat="server">
        <div class="container">
            <p class="h1" id="mainHeading">Search Instructor</p>
            <br />
            <br />
            ...
            <br />
            <table class="table">
                <asp:repeater id="instructorRepeater" runat="server" onitemcommand="instructorRepeater_ItemCommand">
                <HeaderTemplate>
