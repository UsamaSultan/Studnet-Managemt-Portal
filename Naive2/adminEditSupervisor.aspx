<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="adminEditSupervisor.aspx.cs" Inherits="Naive2.adminEditSupervisor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <form id="form1" role="form" class="form-horizontal" runat="server">
            <p class="h1" id="mainHeading">Edit Supervisor</p>
               <div class="row">
                <div class="col-sm-9">
                </div>
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-offset-2 col-sm-7">
                    <asp:Button class="btn btn-default" Text="Edit Supervisor" runat="server"/>
                </div>
             </div>
        </form>
    </div>
